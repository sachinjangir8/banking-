...
// ------------------------------------------------------------------
// JOINT ACCOUNTS ROUTES
// ------------------------------------------------------------------

app.get('/api/joint-accounts', requireAuth, async (req, res) => {
    try {
        const { rows } = await pool.query(`
...
app.post('/api/joint-accounts', requireAuth, async (req, res) => {
...
app.delete('/api/joint-accounts/:id', requireAuth, async (req, res) => {
    try {
